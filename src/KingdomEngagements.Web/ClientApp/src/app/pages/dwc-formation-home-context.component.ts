  ...
  template: `
    <section class="formation-home">
      ...
      <section class="group-bar">
        ...
        <div class="group-links"><a href="/organization/dwc/groups">Groups Home</a><a [href]="memberHref()">Member preview</a><a class="quiet" [href]="toolsHref('curriculum')">Ministry Tools</a></div>
      </section>
