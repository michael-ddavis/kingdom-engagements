...
@Component({
  ...
  styles: [`
    ...
    .assignment-tabs{display:flex;align-items:flex-end;gap:.65rem;margin-top:.9rem;padding:.45rem .65rem .2rem;border-bottom:1px solid var(--eng-line);background:rgba(255,255,255,.38);overflow-x:auto}.tab-cluster{display:grid;gap:.1rem;flex:0 0 auto}.tab-cluster>span{padding-left:.45rem;color:#8a909b;font-size:.54rem;font-weight:900;letter-spacing:.11em;text-transform:uppercase}.tab-cluster--ministry>span{color:var(--eng-blue)}.tab-cluster>div{display:flex}.tab-cluster button{min-height:38px;padding:.45rem .72rem;border:0;border-bottom:2px solid transparent;color:#5f6878;background:transparent;font-size:.72rem;font-weight:800;white-space:nowrap;cursor:pointer}.tab-cluster button:hover{color:var(--eng-ink);background:rgba(255,255,255,.5)}.tab-cluster button.active{border-bottom-color:var(--eng-violet);color:var(--eng-ink);background:#fff}.tab-cluster--ministry button.active{border-bottom-color:var(--eng-blue)}.tab-divider{width:1px;height:28px;margin-bottom:.35rem;background:var(--eng-line);flex:0 0 1px}
    ...
    @media(max-width:900px){.overview-primary{grid-template-columns:1fr}.assignment-brief{border-right:0;border-bottom:1px solid var(--eng-line)}.workspace-header__status{display:none}.attention-strip{grid-template-columns:1fr}}
    @media(max-width:620px){.workspace-header{align-items:flex-start}.assignment-brief dl{grid-template-columns:1fr}.assignment-tabs{margin-inline:-.25rem;padding-inline:.25rem}.tab-cluster button{padding-inline:.58rem}}
  `],
})
