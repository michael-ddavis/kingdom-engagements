    ...
    <section class="ctg-home">
      <header class="ctg-hero">
        ...
        <aside>
          ...
          <div class="aside-actions"><a href="/organization/ctg/bookings">Open Booking Desk →</a><a href="/organization/ctg/start-invitation">Start host invitation →</a></div>
        </aside>
      </header>
      ...
      <section class="flow-section">
        ...
        <div class="flow-list">
          <article>
            ...
            <div class="flow-actions"><a href="/organization/ctg/bookings">Manage bookings →</a><a href="/organization/ctg/start-invitation">Start invitation for host →</a></div>
          </article>
          <article>
