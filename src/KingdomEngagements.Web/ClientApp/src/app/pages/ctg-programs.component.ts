    ...
    <section class="programs-page">
      <header class="programs-header">
        ...
        <div class="header-actions">
          <a href="/register/power-glory-2026" target="_blank">Registration</a>
          <a class="primary" href="/join-the-12" target="_blank">Power of 12 application</a>
        </div>
      </header>
