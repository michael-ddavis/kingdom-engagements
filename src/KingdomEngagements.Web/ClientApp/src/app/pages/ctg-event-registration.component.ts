    ...
    <main class="registration-page">
      @if (event(); as conference) {
        <section class="event-hero">
          <img class="brand brand--signature" src="/ctg/ctg-signature-white.webp" alt="Cynthia Thompson Global" />
